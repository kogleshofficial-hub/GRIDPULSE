...
export default function Dashboard({ initial }: { initial: DashboardPayload }) {
  ...
  return <div className="shell">
    ...
    </main><footer className="footer"><span>GRIDPULSE // EVIDENCE-FIRST INFRASTRUCTURE INTELLIGENCE</span><span>DATA STATUS: {outageCount ? `${outageCount} OUTAGE SIGNALS` : "NO ACTIVE OUTAGE SIGNALS"}</span></footer>
  </div>;
}
